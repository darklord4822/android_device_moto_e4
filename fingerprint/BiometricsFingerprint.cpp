 ...
 */
#define LOG_TAG "android.hardware.biometrics.fingerprint.microarray@2.1-service"
#define LOG_VERBOSE "android.hardware.biometrics.fingerprint.microarray@2.1-service"
...
fingerprint_device_t* BiometricsFingerprint::openHal() {
    ...
    if (0 != (err = hw_get_module("microarray.fingerprint", &hw_mdl))) {
